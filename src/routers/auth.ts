...
import { redirectIfAuth, requireAuth } from "../middleware/isAuth.js";
...
router.get("/cikis-yap", generalLimiter, (req, res) => res.redirect("/"));
router.post("/cikis-yap", generalLimiter, requireAuth, authController.logout_post);
